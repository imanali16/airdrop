...
const contractAddress = '0x4703041f0b0745F08D610548576F702d2B078E96';
const contractABI = [
	{
		"inputs": [],
...
document.getElementById("airdropForm").addEventListener("submit", async function (event) {
	...
	for (let i = 0; i < addresses.length; i++) {
		...
		try {
			const result = await contract.methods.airdrop(address, amount).send({ from: web3.eth.defaultAccount });
			console.log(result);
		} catch (error) {
			console.error(error);
		}
